...
const CONFIG = {
  ...
  services: [
    { ico: "💇‍♀️", title: "قص وتصفيف", desc: "قص عصري وتصفيف أنيق يناسب إطلالتك بأيدي محترفات.", price: "" },
    { ico: "🎨", title: "صبغة وألوان", desc: "صبغة احترافية، هايلايت وبالاج بأحدث الصيحات العالمية.", price: "" },
    { ico: "💆‍♀️", title: "تمويج ومعالجة", desc: "تمويج، تنعيم، وعلاج عميق للشعر يمنحه لمعاناً وحيوية.", price: "" },
    { ico: "💅", title: "عناية ومكياج", desc: "عناية كاملة بالبشرة ومكياج راقٍ لكل المناسبات.", price: "" },
  ],
};
